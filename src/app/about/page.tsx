      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
            About Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">MERN Full-Stack App</span>
          </h1>
          <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
            A comprehensive, production-ready web application demonstrating modern full-stack development practices.
          </p>
        </div>
